...
public class Logical {
	...
	public static void main(String[] args) {
		/* 5. 논리연산자(Logical) : 논리적인 조건을 다룰 때 사용한다.
		                         &&(논리AND/논리곱) : 두 항이 모두 참인 경우 참, 아니면 거짓. ex) boolean  val = (5 > 2) && (5 > 3);
		                         ||(논리OR/논리합) : 두 항중 하나의 항이라도 참이면 참. ex) boolean val = (5 > 2) || (5 < 3);
		                         !(논리NOT/논리부정) : 참인 경우는 거짓으로 바꾸고, 거짓인 경우는 참으로 바꿈. ex) boolean val = !(5 > 2); */
		boolean isTrue = true;
